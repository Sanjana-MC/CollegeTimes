<?php
   //Establishment of connection
    ...
    $result = mysqli_query($con,"SELECT fest_type,event_id,college_name,event_info,events,date_event,time_event,cost,limit_event FROM event_registration WHERE events='seminars'");
?>
<html>
<head>
    <title>College Times-Seminars</title>
    <!-- Favicons -->
        ...
        <div class="container">
            ...
            <nav class="main-nav float-right d-none d-lg-block">
                <ul>
                    ...
                    <li class="active"><a href="http://localhost/COLLEGE_TIMES%20CODE/MODULE%20TWO/seminars.php">Seminars</a></li>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-6 text-center mb-5">
                    <font color="#007bff" size="6px">Seminars</font><br>
                </div>
            </div>
            <!--Seminars Table-->
            <div class="row">
