<?php
   //Establishment of connection
    ...
    $result = mysqli_query($con,"SELECT fest_type,event_id,college_name,event_info,events,date_event,time_event,cost,limit_event FROM event_registration WHERE fest_type='College'");
?>
<html>
<head>
                ...
                <ul>
                    ...
                    <li class="drop-down"><a href="">Fests</a>
                        <ul>
                            ...
                            <li class="active"><a href="http://localhost/COLLEGE_TIMES%20CODE/MODULE%20TWO/college_events.php">College</a></li>
                        </ul>
                    </li>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-6 text-center mb-5">
                    <font color="#007bff" size="6px">College Events</font><br>
                </div>
            </div>
