<?php
    ...
    $result = mysqli_query($con,"SELECT fest_type,event_id,college_name,event_info,events,date_event,time_event,cost,limit_event FROM event_registration WHERE events='webinars'");
?>
<html>
<head>
    <title>College Times-Webinars</title>
    <!-- Favicons -->
    ...
    <!-- Google Fonts -->
    <link ref="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i|Montserrat:300,400,500,700" rel="stylesheet">
            ...
            <nav class="main-nav float-right d-none d-lg-block">
                <ul>
                    ...
                    <li class="drop-down"><a href="">Fests</a>
                        <ul>
                            <li><a href="http://localhost/COLLEGE_TIMES%20CODE/MODULE%20TWO/department_events.php">Department</a></li>
                            <li><a href="http://localhost/COLLEGE_TIMES%20CODE/MODULE%20TWO/college_events.php">College</a></li>
                        </ul>
                    </li>
                    <li class="active"><a href="http://localhost/COLLEGE_TIMES%20CODE/MODULE%20TWO/webinar.php">Webinars</a></li>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-6 text-center mb-5">
                    <font color="#007bff" size="6px">Webinars</font><br>
                </div>
            </div>
            <!--Webinars Table-->
            <div class="row">
                <div class="col-md-12">
                    <div class="table-wrap">
                        <table class="table">
                            ...
                            <marquee>Go to respective fest type tab for participation</marquee>
