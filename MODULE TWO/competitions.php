...
//Establishment of Connection
  ...
  $result = mysqli_query($con,"SELECT fest_type,event_id,college_name,event_info,events,date_event,time_event,cost,limit_event FROM event_registration WHERE events='Competitions'");
?>
<html>
<head>
    <title>College Times-Events</title>    
        ...
        <div class="container">
            ...
            <nav class="main-nav float-right d-none d-lg-block">
                <ul>
                    ...
                    <li class="active"><a href="http://localhost/COLLEGE_TIMES%20CODE/MODULE%20TWO/competitions.php">Events</a></li>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-6 text-center mb-5">
                    <font color="#007bff" size="6px">Competitions</font><br>
                </div>
            </div>
             <!--Competitions Table-->
            <div class="row">
